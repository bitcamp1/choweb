...
<div class="head">
			<h1><a href="/" onclick="setClickLog('/메인/GNB/로고');"><img src="http://img.cgv.co.kr/R2014/images/title/h1_cgv.png" alt="CGV" /></a></h1>
			<div class="sect-service">
				...
				<ul class="gnb">
                    ...
                    <li><a href="login_page.do" class="login" onclick="setClickLog('/GNB/로그인');"><span>로그인</span></a></li>
					<li><a href="sign_page.do" class="join" onclick="setClickLog('/GNB/회원가입');"><span>회원가입</span></a></li>
                    
                

					<li><a href="/user/mycgv/" class="mycgv required-login" data-url="/user/mycgv/" onclick="setClickLog('/GNB/MYCGV');"><span>MY CGV</span></a></li>
					<li><a href="/user/vip-lounge/" class="vip" onclick="setClickLog('/GNB/VIPLOUNGE');"><span>VIP LOUNGE</span></a></li>
					<li><a href="#" title="새창" class="club specialclub" onclick="setClickLog('/GNB/특별관CLUB');" ><span>특별관 CLUB</span></a></li>
					<!-- 2014.12.8 리뉴얼-->
					<li><a href="/support/default.aspx" class="customer" onclick="setClickLog('/GNB/고객센터');"><span>고객센터</span></a></li>
				    <!-- 2014.12.8 리뉴얼-->
					<li><a href="/reserve/show-times/eng/" class="showtimes"  onclick="setClickLog('/GNB/EnglishTicketing');"  ><span>ENGLISH TICKETING</span></a></li>
				</ul>
			</div>
            ...
            <div class="im-wrap"> <!-- Important wrap -->
				...
				<div class="lnb">
					<h2>CGV 주메뉴</h2>
					<ul id="gnb_list">
						<li class="movie"><a href="reserve.do">영화</a>
							<div class="sub-wrap">
								<i></i>
								<div class="smenu">
									<ul>
										<li><a href="/movies/?ft=0" onclick="setClickLog('/GNB/영화/무비차트');">무비차트</a></li>
										<li><a href="/movies/hd-trailer.aspx" onclick="setClickLog('/GNB/영화/HD트레일러');">HD 트레일러</a></li>
										<li><a href="/movies/finder.aspx" onclick="setClickLog('/GNB/영화/무비파인더');">무비파인더</a></li>
										<li><a href="/movies/point/" onclick="setClickLog('/GNB/영화/평점');">평점</a></li>
										<li class="last"><a href="/arthouse/" onclick="setClickLog('/GNB/영화/아트하우스');">CGV아트하우스</a></li>
									</ul>
								</div>
							</div>
						</li>
						<li class="booking"><a href="ticket.do">예매</a>
							<div class="sub-wrap">
								<i></i>
								<div class="smenu">
									<ul>
				...
				<div class="ad-partner">
                    <a href="http://section.cgv.co.kr/discount/Special/discount/Default.aspx"  onclick="setClickLog('/GNB/제휴배너(검색)');">
